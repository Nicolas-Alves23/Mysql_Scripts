...
VALUES ('Eric Matthes', NULL, 'Autor de livros introdutórios sobre programação.');

INSERT INTO categoria (nome)
VALUES ('Técnico');

INSERT INTO livro (titulo, isbn, descricao)
VALUES ('Python', '978-85-01-00000-7', 'Livro técnico sobre programação em Python.');
...
VALUES
	('Teste Testador', 'USR007', 'teste@gmail.com', '2025-04-11', '1');
...
DELETE FROM livro_autor WHERE status = 'danificado';
DELETE FROM livro_categoria WHERE status = 'danificado';
DELETE FROM emprestimo WHERE status = 'danificado';

DELETE FROM livro WHERE status = 'danificado';

INSERT INTO emprestimo (usuario_id, livro_id, data_emprestimo, data_limite, data_devolucao)
VALUES (1, 1, '2020-06-15', '2020-06-30', '2020-06-28');

DELETE FROM emprestimo
WHERE data_emprestimo >= '2020-01-01' AND data_emprestimo <= '2020-12-31';